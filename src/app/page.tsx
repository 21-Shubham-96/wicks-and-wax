...
const sampleCandles: Candle[] = [
  {
    ...
    name: "Rose Delight",
    category: "Gifting",
    image: "/candles/rose_delight.jpeg",
    price: "150",
  },
  {
    id: 2,
    name: "Mint Sparkle",
    category: "Birthdays",
    image: "/candles/mint_sparkle.jpeg",
    price: "120",
  },
  {
    id: 3,
      ...
      {viewWishlist && (
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 w-11/12 max-w-md bg-white border border-pink-300 rounded-xl p-4 shadow-lg">
          <div className="flex justify-between items-center mb-4">
            ...
            <button onClick={() => setViewWishlist(false)} className="text-pink-600">
              <X />
            </button>
          </div>
          {wishlist.length === 0 ? (
      ...
      {viewCart && (
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 w-11/12 max-w-md bg-white border border-pink-300 rounded-xl p-4 shadow-lg">
          <div className="flex justify-between items-center mb-4">
            ...
            <button onClick={() => setViewCart(false)} className="text-pink-600">
              <X />
            </button>
          </div>
          {cart.length === 0 ? (
            ...
            cart.map(({ id, qty }) => (
              <div key={id} className="flex justify-between items-center py-2 border-b">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    onClick={() => setCart((prev) => prev.filter((item) => item.id !== id))}
          ...
          return (
            ...
            >
              ...
              <div className="flex justify-between items-center mt-4">
                ...
                <div className="flex items-center gap-2">
                  <button
                    onClick={() => decrementQty(candle.id)}
                  ...
                  <button
                    onClick={() => incrementQty(candle.id)}
                    className="p-1 text-pink-600"
                  >
                    <Plus size={16} />
                  </button>
